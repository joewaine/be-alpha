...
var tween = TweenMax.staggerFromTo(".animate_t_2_1", 2, {transform: "translateY(-150px)", opacity: 0}, {transform: "translateY(0)", opacity: 1, ease: Circ.easeOut}, 0.05);
...
// build entrance tween
var tween = TweenMax.staggerFromTo(".animate_t_2_2", 2, {transform: "translateY(150px)", opacity: 0}, {transform: "translateY(0)", opacity: 1, ease: Circ.easeOut}, 0.05);
...
// build entrance scene
var scene = new ScrollMagic.Scene({triggerElement: "#trigger_2_in_content", duration: 300})
                .setTween(tween)
                // .addIndicators({name: "staggering 2"}) // add indicators (requires plugin)
                .addTo(controller);
